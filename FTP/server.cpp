...
int explain(string &cmd)
{
    ...
    if (cmd.substr(0, 4) == "SIZE")
        return 8;
    if (cmd.substr(0, 4) == "TYPE")
        return 9;
    if (cmd.substr(0, 4) == "REST")
        return 10;
    return 0;
}
...
void process_client(int clientfd)
{
    ...
    while (isrun)
    {
        ...
        {
        case 1:
            cmd_user(clientfd, cmd);
            break;
        case 2:
            cmd_pass(clientfd, cmd, isright);
            break;
        case 3:
            cmd_pasv(clientfd, d_listenfd);
            break;
        case 4:
            cmd_list(clientfd, d_listenfd, islogin, isright);
            break;
        case 5:
            cmd_retr(clientfd, d_listenfd, islogin, isright, cmd, file_pos);
            break;
        case 6:
            cmd_stor(clientfd, d_listenfd, islogin, isright, cmd, file_pos);
            break;
        case 7:
            cmd_quit(clientfd);
            isrun = false;
            break;
        case 8:
            cmd_size(clientfd, cmd);
            break;
        case 9:
            cmd_type(clientfd, cmd);
            break;
        case 10:
            cmd_rest(clientfd, cmd, file_pos);
            break;
        default:
        {
